...
import static com.dykj.zhonganxiao.util.net.NetWorkUtils.getNetworkType;
...
public class NetStateReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(intent.getAction().equalsIgnoreCase(AppConfig.ANDROID_NET_CHANGE_ACTION)){
            LogUtils.logd("网络状态变化了");
            type = getNetworkType();
            post(type);
    ...
    public void unRegisterObserver(Object register) {
        ...
        LogUtils.logd(register.getClass().getName()+"注销成功了");
    }
